...
/**
 * DashboardLookml Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DashboardLookml implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DashboardLookml';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lookml'] = isset($data['lookml']) ? $data['lookml'] : null;
    }
     ...
     * Sets folder_id
     *
     * @param string $folder_id (Write-Only) Id of the folder
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getLookml()
    {
        return $this->container['lookml'];
    }

    /**
     * Sets lookml
     *
     * @param string $lookml lookml of UDD
     *
     * @return $this
     */
    public function setLookml($lookml)
    {
        $this->container['lookml'] = $lookml;
