...
/**
 * DependencyGraph Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DependencyGraph implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DependencyGraph';
    ...
    {
        $this->container['graph_text'] = isset($data['graph_text']) ? $data['graph_text'] : null;
    }
    ...
    {
        return $this->container['graph_text'];
    }

    /**
     * Sets graph_text
     *
     * @param string $graph_text The graph structure in the dot language that can be rendered into an image.
     *
     * @return $this
     */
    public function setGraphText($graph_text)
    {
        $this->container['graph_text'] = $graph_text;
