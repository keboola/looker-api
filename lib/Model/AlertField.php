 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlertField implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlertField';
    ...
    protected static $swaggerTypes = [
        'title' => 'string',
        'name' => 'string',
        'filter' => '\Swagger\Client\Model\AlertFieldFilter[]'
    ];
     ...
     * Sets title
     *
     * @param string $title Field's title. Usually auto-generated to reflect field name and its filters
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Field's name. Has the format `<view>.<field>` Refer to [docs](https://cloud.google.com/looker/docs/sharing-and-publishing/creating-alerts) for more details
     *
     * @return $this
     */
     ...
     * Gets filter
     *
     * @return \Swagger\Client\Model\AlertFieldFilter[]
     */
