...
class CredentialsEmail implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'email' => 'setEmail',
        'forced_password_reset_at_next_login' => 'setForcedPasswordResetAtNextLogin',
    ...
    protected static $getters = [
        ...
        'email' => 'getEmail',
        'forced_password_reset_at_next_login' => 'getForcedPasswordResetAtNextLogin',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['forced_password_reset_at_next_login'] = isset($data['forced_password_reset_at_next_login']) ? $data['forced_password_reset_at_next_login'] : null;
    ...
    /**
     * Gets forced_password_reset_at_next_login
     *
     * @return bool
     */
    public function getForcedPasswordResetAtNextLogin()
    {
        return $this->container['forced_password_reset_at_next_login'];
    }

    /**
     * Sets forced_password_reset_at_next_login
     *
     * @param bool $forced_password_reset_at_next_login Force the user to change their password upon their next login
     *
     * @return $this
     */
    public function setForcedPasswordResetAtNextLogin($forced_password_reset_at_next_login)
    {
        $this->container['forced_password_reset_at_next_login'] = $forced_password_reset_at_next_login;
