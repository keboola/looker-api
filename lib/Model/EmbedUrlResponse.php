...
/**
 * EmbedUrlResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmbedUrlResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmbedUrlResponse';
     ...
     * Sets url
     *
     * @param string $url The embed URL. Any modification to this string will make the URL unusable.
     *
     * @return $this
     */
