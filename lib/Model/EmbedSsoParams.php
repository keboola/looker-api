 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmbedSsoParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmbedSsoParams';
     ...
     * Sets secret_id
     *
     * @param string $secret_id Id of the embed secret to use to sign this SSO url. If specified, the value must be an id of a valid (active) secret defined in the Looker instance. If not specified, the URL will be signed with the newest active embed secret defined in the Looker instance.
     *
     * @return $this
     */
