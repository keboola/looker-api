...
class DataActionRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets action
     *
     * @param object $action The JSON describing the data action. This JSON should be considered opaque and should be passed through unmodified from the query result it came from.
     *
     * @return $this
     */
