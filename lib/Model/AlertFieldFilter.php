...
/**
 * AlertFieldFilter Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AlertFieldFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlertFieldFilter';
     ...
     * Sets field_name
     *
     * @param string $field_name Field Name. Has format `<view>.<field>`
     *
     * @return $this
     */
     ...
     * Sets filter_value
     *
     * @param string $filter_value Filter Value. Usually null except for [location](https://cloud.google.com/looker/docs/reference/field-reference/dimension-type-reference#location) type. It'll be a string of lat,long ie `'1.0,56.0'`
     *
     * @return $this
     */
