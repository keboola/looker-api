...
/**
 * WelcomeEmailTest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WelcomeEmailTest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WelcomeEmailTest';
     ...
     * Sets content
     *
     * @param string $content The content that would be sent in the body of a custom welcome email
     *
     * @return $this
     */
     ...
     * Sets subject
     *
     * @param string $subject The subject that would be sent for the custom welcome email
     *
     * @return $this
     */
     ...
     * Sets header
     *
     * @param string $header The header that would be sent in the body of a custom welcome email
     *
     * @return $this
     */
