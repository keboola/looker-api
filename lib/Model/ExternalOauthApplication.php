 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExternalOauthApplication implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalOauthApplication';
     ...
     * Sets id
     *
     * @param string $id ID of this OAuth Application
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this application.  For Snowflake connections, this should be the name of the host database.
     *
     * @return $this
     */
     ...
     * Sets client_id
     *
     * @param string $client_id The OAuth Client ID for this application
     *
     * @return $this
     */
     ...
     * Sets client_secret
     *
     * @param string $client_secret (Write-Only) The OAuth Client Secret for this application
     *
     * @return $this
     */
     ...
     * Sets dialect_name
     *
     * @param string $dialect_name The database dialect for this application.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Creation time for this application
     *
     * @return $this
     */
