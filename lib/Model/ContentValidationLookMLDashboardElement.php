...
/**
 * ContentValidationLookMLDashboardElement Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContentValidationLookMLDashboardElement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContentValidationLookMLDashboardElement';
     ...
     * Sets lookml_link_id
     *
     * @param string $lookml_link_id Link ID of the LookML Dashboard Element
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string $title Title of the LookML Dashboard Element
     *
     * @return $this
     */
