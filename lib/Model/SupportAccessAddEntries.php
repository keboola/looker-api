...
/**
 * SupportAccessAddEntries Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SupportAccessAddEntries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SupportAccessAddEntries';
     ...
     * Sets emails
     *
     * @param string[] $emails An array of emails to add to the Allowlist
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string $reason Reason for adding emails to the Allowlist
     *
     * @return $this
     */
